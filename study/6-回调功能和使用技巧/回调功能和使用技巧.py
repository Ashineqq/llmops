...
# print(
#     chain.invoke(
#         {"query": "我叫什么名字", "config": {"callbacks": [StdOutCallbackHandler()]}}
#     )
# )

chain = {"query": RunnablePassthrough()} | prompt_template | llm | parser

print(chain.invoke("我叫什么名字", config={"callbacks": [StdOutCallbackHandler()]}))
